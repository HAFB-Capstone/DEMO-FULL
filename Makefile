...
urls:
	...
	@echo "==============================================================="
	@echo "  Enter the lab container (repo bind-mounted at /lab) Run the following:"
	...
	@echo "  Docs: "
	@echo " 	apps/SBOM-XRay/student/sbom-xray-lab-student-guide.md"
	@echo "  	and apps/SBOM-XRay/sbom-xray-lab-student-worksheet.md"
	@echo ""
	@echo "==============================================================="
	@echo "  SERVICES"
	@echo "==============================================================="
